...
var mongoSerializer = null;

try { mongoSerializer = require('h5.rql/lib/serializers/mongoSerializer'); } catch (err) {}
...
exports.browseRoute = function(app, options, req, res, next)
{
  ...
  var queryOptions = mongoSerializer ? mongoSerializer.fromQuery(req.rql) : {};
